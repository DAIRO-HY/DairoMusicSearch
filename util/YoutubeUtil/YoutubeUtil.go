...
func RequestCollectMusic(videoId string) {
	...
	cmd := "yt-dlp --cookies youtube-cookie.txt --no-check-certificate -x --audio-format mp3 --audio-quality 0 -o \"" + mp3File + "\" https://www.youtube.com/watch?v=" + videoId + ""
...
func GetLRC(videoId string) string {
	...
	command := "yt-dlp --cookies youtube-cookie.txt --no-check-certificate --write-subs --sub-lang all --skip-download https://www.youtube.com/watch?v=" + videoId + " -o \"" + folder + "/lrc\""
